...
//     possible to get to the pump or not. Function should return true (1 in Prolog and NASM) if it is possible and
//     false (0 in Prolog and NASM) if not. The input values are always positive.
